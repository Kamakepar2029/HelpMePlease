...
public class UploadActivity extends Activity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (webview1.getUrl().equals("https://upload--p1eas1ng.repl.co/")) {
					FileUtil.writeFile("/storage/emulated/0/Android/data/com.help.me/web.txt", "");
				}
				else {
					FileUtil.writeFile("/storage/emulated/0/Android/data/com.help.me/web.txt", webview1.getUrl());
				}
				finish();
			}
		});
	...
	private void initializeLogic() {
		...
		webview1.loadUrl("https://upload--konsttlt86.repl.co");
	}
	...
	public void onBackPressed() {
		if (webview1.getUrl().equals("https://upload--konsttlt86.repl.co/")) {
			FileUtil.writeFile("/storage/emulated/0/Android/data/com.help.me/web.txt", "");
		}
		else {
			FileUtil.writeFile("/storage/emulated/0/Android/data/com.help.me/web.txt", webview1.getUrl());
